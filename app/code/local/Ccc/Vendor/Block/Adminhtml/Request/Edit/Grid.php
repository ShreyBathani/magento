...
class Ccc_Vendor_Block_Adminhtml_Request_Edit_Grid extends Mage_Adminhtml_Block_Widget_Grid
{
    public function __construct() {
        ...
        $this->setVarNameFilter('edited_vendor_product_filter');
    }
    ...
    protected function _prepareCollection()
    {
        ...
        $collection->addAttributeToFilter('vendor_product_request_status', ['=' => Ccc_Vendor_Model_Product_Request::REQUEST_EDIT])
