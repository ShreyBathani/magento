...
class Ccc_Vendor_Block_Adminhtml_Product_Edit_Tab_Settings extends Mage_Adminhtml_Block_Widget_Form
{
    ...
    protected function _prepareForm()
    {
        ...
        $fieldset = $form->addFieldset('settings', array('legend'=>Mage::helper('vendor')->__('Create Practice1 Settings')));
