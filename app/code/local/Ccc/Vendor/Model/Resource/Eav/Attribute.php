...
class Ccc_Vendor_Model_Resource_Eav_Attribute extends Mage_Eav_Model_Entity_Attribute
{
    ...
    public function getGroupId()
    {
        ...
        $query = "SELECT `attribute_group_id` FROM `eav_entity_attribute` WHERE `attribute_id` = '{$this->getId()}' AND `entity_type_id` = '{$this->getEntityTypeId()}'";
        
        $result = $readConnection->fetchRow($query);
        
        if ($result) {
            return $result['attribute_group_id'];
        }
        return null;
    }

    public function removeRelation($group_id)
    {
        $readConnection = $this->_getResource()->getReadConnection();

        $query = "DELETE FROM `eav_entity_attribute` WHERE `attribute_id` = '{$this->getId()}' AND `entity_type_id` = '{$this->getEntityTypeId()}' AND `attribute_group_id` = '{$group_id}';";
    ...
    public function getOptions()
    {
        ...
        $query = "SELECT * FROM `eav_attribute_option` 
