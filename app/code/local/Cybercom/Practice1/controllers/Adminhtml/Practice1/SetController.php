...
class Cybercom_Practice1_Adminhtml_Practice1_SetController extends Mage_Adminhtml_Controller_Action
{
    public function indexAction()
    {
        ...
        $this->_addBreadcrumb(Mage::helper('catalog')->__('Practice1'), Mage::helper('catalog')->__('Practice1'));
        $this->_addBreadcrumb(
            Mage::helper('catalog')->__('Manage Attribute Sets'),
            Mage::helper('catalog')->__('Manage Attribute Sets'));

        $this->_addContent($this->getLayout()->createBlock('practice1/adminhtml_practice1_attribute_set_toolbar_main'));
        $this->_addContent($this->getLayout()->createBlock('practice1/adminhtml_practice1_attribute_set_grid'));
    ...
    public function editAction()
    {
        ...
        $this->_addBreadcrumb(Mage::helper('catalog')->__('Practice1'), Mage::helper('catalog')->__('Practice1'));
        $this->_addBreadcrumb(
            Mage::helper('catalog')->__('Manage Practice1 Sets'),
            Mage::helper('catalog')->__('Manage Practice1 Sets'));
        
        $this->_addContent($this->getLayout()->createBlock('practice1/adminhtml_practice1_attribute_set_main'));
    ...
    public function setGridAction()
    {
        ...
        $this->getResponse()->setBody(
            $this->getLayout()
                ->createBlock('practice1/adminhtml_practice1_attribute_set_grid')
                ->toHtml());
    }
    ...
    public function addAction()
    {
        ...
        $this->_addContent($this->getLayout()->createBlock('practice1/adminhtml_practice1_attribute_set_toolbar_add'));
    ...
    protected function _setTypeId()
    {
        Mage::register('entityType',
            Mage::getModel('practice1/practice1')->getResource()->getTypeId());
    }
