 ...
 */
class Cybercom_Practice1_Block_Adminhtml_Practice1_Attribute_Edit_Tabs extends Mage_Adminhtml_Block_Widget_Tabs
{

    public function __construct()
    {
        parent::__construct();
        $this->setId('practice1_attribute_tabs');
    ...
    protected function _beforeToHtml()
    {
        $this->addTab('main', array(
            ...
            'content'   => $this->getLayout()->createBlock('practice1/adminhtml_practice1_attribute_edit_tab_main')->toHtml(),
            'active'    => true
        ));
        ...
        $this->addTab('labels', array(
            ...
            'content'   => $this->getLayout()->createBlock('practice1/adminhtml_practice1_attribute_edit_tab_options')->toHtml(),
        ));
