...
class Cybercom_Practice1_Block_Adminhtml_Practice1_Attribute_Set_Main_Formgroup extends Mage_Adminhtml_Block_Widget_Form
{
    ...
    protected function _prepareForm()
    {
        ...
        $form->setMethod('post');
        $form->setAction($this->getUrl('*/adminhtml_practice1_group/save'));
        $this->setForm($form);
    }
