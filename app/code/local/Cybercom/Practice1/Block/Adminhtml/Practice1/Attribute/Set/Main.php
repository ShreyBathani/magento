...
class Cybercom_Practice1_Block_Adminhtml_Practice1_Attribute_Set_Main extends Mage_Adminhtml_Block_Template
{
    /**
     * Initialize template
     *
    ...
    {
        $this->setTemplate('practice1/attribute/set/main.phtml');
    }

    /**
     * Prepare Global Layout
     *
     * @return Cybercom_Practice1_Block_Adminhtml_Practice1_Attribute_Main
     */
    protected function _prepareLayout()
    {
        ...
        $this->setChild('group_tree',
            $this->getLayout()->createBlock('practice1/adminhtml_practice1_attribute_set_main_tree_group')
        );

        $this->setChild('edit_set_form',
            $this->getLayout()->createBlock('practice1/adminhtml_practice1_attribute_set_main_formset')
        );
    ...
    {
        return $this->getUrl('*/practice1_set/save', array('id' => $this->_getSetId()));
    }
    ...
    {
        return $this->getUrl('*/practice1_group/save', array('id' => $this->_getSetId()));
    }
    ...
    public function getAttributeTreeJson()
    {
        ...
        $attributes = Mage::getResourceModel('practice1/practice1_attribute_collection')
